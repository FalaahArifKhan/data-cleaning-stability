...
declare -a job_configs=(
    ...
    "german gandalf_clf 1,2,3,4,5,6"
    "folk gandalf_clf 1,2"
    "folk gandalf_clf 3,4"
    "folk gandalf_clf 5,6"
    "law_school gandalf_clf 1,2"
    "law_school gandalf_clf 3,4"
    "law_school gandalf_clf 5,6"
    "bank gandalf_clf 1,2"
    "bank gandalf_clf 3,4"
    "bank gandalf_clf 5,6"
)
