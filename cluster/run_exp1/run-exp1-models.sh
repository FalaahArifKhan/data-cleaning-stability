...
declare -a job_configs=(
    "diabetes median-dummy exp1_mar3 gandalf_clf 6"
    "diabetes median-dummy exp1_mcar3 gandalf_clf 6"
    "diabetes median-dummy exp1_mnar3 gandalf_clf 5,6"
    "diabetes median-mode exp1_mar3 gandalf_clf 5,6"
    "diabetes median-mode exp1_mcar3 gandalf_clf 6"
    "diabetes median-mode exp1_mnar3 gandalf_clf 6"
    "german median-dummy exp1_mnar3 gandalf_clf 6"
