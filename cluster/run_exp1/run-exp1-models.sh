...
#     "bank hivae mixed_exp lgbm_clf 5,6"
     ...
     "folk hivae exp1_mcar3 mlp_clf 2"
     "folk hivae exp1_mcar3 mlp_clf 4"
     "folk hivae exp1_mcar3 mlp_clf 6"
     "folk hivae exp1_mar3 mlp_clf 2"
     "folk hivae exp1_mar3 mlp_clf 4"
     "folk hivae exp1_mar3 mlp_clf 6"
     "folk hivae exp1_mnar3 mlp_clf 2"
     "folk hivae exp1_mnar3 mlp_clf 4"
     "folk hivae exp1_mnar3 mlp_clf 6"
     "folk hivae mixed_exp mlp_clf 2"
     "folk hivae mixed_exp mlp_clf 4"
     "folk hivae mixed_exp mlp_clf 6"
