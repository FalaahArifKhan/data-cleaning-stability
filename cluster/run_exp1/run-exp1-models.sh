...
declare -a job_configs=(
    "folk_emp boost_clean exp1_mcar3 gandalf_clf 1"
    "folk_emp boost_clean exp1_mcar3 gandalf_clf 3"
    "folk_emp boost_clean exp1_mcar3 gandalf_clf 5"

    "folk_emp boost_clean exp1_mar3 gandalf_clf 1"
    "folk_emp boost_clean exp1_mar3 gandalf_clf 3"
    "folk_emp boost_clean exp1_mar3 gandalf_clf 5"

    "folk_emp boost_clean exp1_mnar3 gandalf_clf 1"
    "folk_emp boost_clean exp1_mnar3 gandalf_clf 3"
    "folk_emp boost_clean exp1_mnar3 gandalf_clf 5"
)
