...
if __name__ == "__main__":
    ...
    mcar_injector = NullsInjector(seed=42, strategy='MCAR', columns_with_nulls=["AGEP", "SCHL", "MAR"], null_percentage=0.4)
    df_injected_mcar = mcar_injector.transform(data_loader.X_data)

    mcar_injector2 = NullsInjector(seed=42, strategy='MCAR', columns_with_nulls=["AGEP", "SCHL", "MAR"], null_percentage=0.4)
    ...
    mar_injector = NullsInjector(seed=42, strategy='MAR', columns_with_nulls=["AGEP", "MAR"], null_percentage=0.4, condition=("SEX", "2"))
    df_injected_mar = mar_injector.transform(data_loader.X_data)

    mar_injector2 = NullsInjector(seed=42, strategy='MAR', columns_with_nulls=["AGEP", "MAR"], null_percentage=0.4, condition=("SEX", "2"))
    ...
    mnar_injector = NullsInjector(seed=42, strategy='MNAR', columns_with_nulls=["SEX"], null_percentage=0.4, condition=("SEX", "2"))
