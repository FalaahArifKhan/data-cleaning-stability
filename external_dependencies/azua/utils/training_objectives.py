...
def get_input_and_scoring_processed_masks(
    ...
    *,
    ...
    """
    Apply random dropout to an processed mask, and calculate which output positions should be included in loss calculation for training.
    """

    # Apply random mask droput in unprocessed form
    unprocessed_mask = data_processor.revert_mask(processed_mask)
    unprocessed_input_mask, unprocessed_scoring_mask = get_input_and_scoring_masks(
        unprocessed_mask,
